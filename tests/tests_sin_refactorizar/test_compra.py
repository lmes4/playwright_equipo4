...
def test_compra_datos_validos (page: Page):
    ...
    expect(page.get_by_label("Resumen del Pedido")).to_contain_text("Resumen del Pedido Juego de Palas15.99 €Subtotal (1)15.99 €IVA (21%)3.36 €Envío5.00 €Total24.35 €")
    ...
    page.get_by_role("button", name="Completar Compra").click()
    print ("Comprueba el resumen del pedido completado")
    page.get_by_role("region", name="Resumen del Pedido").click()
    expect(page.get_by_label("Resumen del Pedido")).to_contain_text("Resumen del PedidoJuego de Palas15.99 €Subtotal (1)15.99 €IVA (21%)3.36 €Envío5.00 €Total24.35 €")
